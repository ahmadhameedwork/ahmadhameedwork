...
USER_NAME = os.environ['USER_NAME'] # 'ahmadhameedwork'
...
if __name__ == '__main__':
    """
    Ahmad Hameed (ahmadhameedwork), adapted from Andrew Grant (Andrew6rant), 2022-2026
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 9, 6))
