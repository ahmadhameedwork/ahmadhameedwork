"""Generate dark_mode.svg and light_mode.svg for ahmadhameedwork's profile card.
...
def right_panel():
    r = ['<text x="390" y="30">']
    r.append(f'<tspan x="390" y="30">ahmad@hameed</tspan> {DASH_LINE}')
    r.append(row(50, ['OS'], 'Windows 11, Android 16, Ubuntu'))
    r.append(row(70, ['Uptime'], '21 years, 11 months, 17 days', ids='age_data'))
    r.append(row(90, ['Host'], 'FAST NUCES, Islamabad'))
    ...
    r.append(row(210, ['Languages', 'Real'], 'English, Urdu'))
    r.append(blank(230))
    ...
    r.append(row(330, ['Email'], 'ahmadhameedwork@gmail.com'))
    r.append(row(350, ['Website'], 'ahmadhameed.works'))
    r.append(row(370, ['LinkedIn'], 'ahmadhameedwork'))
    r.append(row(390, ['GitHub'], 'ahmadhameedwork'))
